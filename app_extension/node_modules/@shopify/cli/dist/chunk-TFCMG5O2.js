...
async function launchCLI(options) {
  let { errorHandler } = await import("./error-handler-HVEM4RKZ.js"), { isDevelopment } = await import("./local-UX2FKODS.js"), oclif = await import("./lib-IZAG57CE.js"), { ShopifyConfig } = await import("./custom-oclif-loader-BGXT6N23.js");
...
async function exitIfOldNodeVersion(versions = process.versions) {
  ...
  if (nodeMajorVersion < 18) {
    let { renderError } = await import("./ui-FQHY2OWD.js");
    renderError({
...
async function addInitToArgvWhenRunningCreateCLI(options, argv = process.argv) {
  let { findUpAndReadPackageJson } = await import("./node-package-manager-NS6MYGUI.js"), { moduleDirectory } = await import("./path-2K5HIMHZ.js"), name = (await findUpAndReadPackageJson(moduleDirectory(options.moduleURL))).content.name.replace("@shopify/create-", "");
...
//# sourceMappingURL=chunk-TFCMG5O2.js.map
